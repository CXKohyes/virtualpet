 ...
 * 三条规则，对应 PRD 的三句话：
 *
 * 1. 台词**按物种和状态分开**：猫傲娇、狗热情、龙中二、兔子一惊一乍，
 *    同一个状态四只说法不同。
...
export const PET_STATUS_LINES: Record<Species, Record<PetStatus, readonly string[]>> = {
  ...
  // ---------------------------------------------------------- 兔子：胆小、警觉，一惊一乍
  RABBIT: {
    NORMAL: ['耳朵一直在听动静。', '现在……安全吗？', '我在这儿，没乱跑。'],
    HUNGRY: ['肚子在响，会不会引来别的东西……', '那个……可以吃了吗？', '我小口小口吃就好。'],
    DIRTY: ['毛上沾了土，好难受。', '想把自己舔干净……够不着。', '别看我，我现在乱糟糟的。'],
    TIRED: ['耳朵都耷下来了。', '让我靠一会儿……就一会儿。', '我快睁不开眼了。'],
    SAD: ['你是不是不想要我了。', '我一直在角落里待着。', '……没事。我习惯了。'],
    SICK: ['我抖得停不下来……', '身体好烫。', '别走，好不好。'],
    SLEEPING: ['（鼻子还在轻轻抽动）', '耳朵压到脸上了……', '一点声音就会醒……zzz'],
  },
}
...
export const PET_SCENE_LINES: Record<Species, Record<SpeechScene, readonly string[]>> = {
  ...
  RABBIT: {
    FEED: ['谢谢……我吃了。', '这个好吃！我记住了。', '我留了一半，等一下再吃。'],
    PLAY: ['哇！等一下——太快了！', '再来一次！这次我不怕了！', '蹦起来的感觉真好。'],
    CLEAN: ['轻一点……我怕痒。', '干净了。你闻闻，是草的味道。', '毛顺了，我可以躲得更快了。'],
    SLEEP: ['我睡了……你还在吧？', '有你在旁边，我睡得着。', '别关灯。'],
    WAKE: ['呀！我醒了！我醒着呢！', '我做了个梦，梦见一直被追……', '几点了？我睡了很久吗？'],
    LEVEL_UP: ['我变强了……真的吗？', '现在我能跑得更远了！', '你有没有发现我长高了一点。'],
    EVOLVE: ['我……长这么大了？', '耳朵也变长了，听得更清楚。', '我好像没那么害怕了。'],
    SICK: ['我好像……不太对劲。', '别碰我，我怕传染给你。', '我会好起来的，你别担心。'],
    RETURN: ['你回来了！我一直在等你！', '我一直数着脚步声……', '下次……可以早点回来吗。'],
  },
}
